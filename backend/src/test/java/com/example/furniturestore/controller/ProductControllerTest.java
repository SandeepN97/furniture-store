...
class ProductControllerTest {
    ...
    void setUp() {
        ...
        Product chair = new Product("Chair", new BigDecimal("20.00"), "Nice chair", null, category);
        chair.setStockQuantity(5);
        productRepository.save(chair);
        Product table = new Product("Table", new BigDecimal("30.00"), "Nice table", null, category);
