...
public class FurnitureStoreApplication {
    ...
    CommandLineRunner initDatabase(ProductRepository productRepository,
            ...
            com.example.furniturestore.search.ProductSearchService searchService) {
        return args -> {
            if (categoryRepository.count() == 0) {
                ...
                if (productRepository.count() == 0) {
                    Product p1 = productRepository.save(new Product("Chair",
                            new BigDecimal("49.99"),
                            "Comfortable wooden chair",
                            "https://via.placeholder.com/150",
                            seating,
                            10));
                    Product p2 = productRepository.save(new Product("Dining Table",
                            new BigDecimal("149.99"),
                            "Large table for family meals",
                            "https://via.placeholder.com/150",
                            tables,
                            5));
                    Product p3 = productRepository.save(new Product("Bookshelf",
                    ...
                    if (searchService != null) {
                        searchService.indexProduct(p1);
                        searchService.indexProduct(p2);
                        searchService.indexProduct(p3);
                    }
                }
            }
